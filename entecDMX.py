...
class PyDMX():
    ...
    def run(self):
		...
		while self.DMX:
			...
			#elf.set_channel(1, RGB[0] * BRIGHTNESS)
			...
			self.set_channel(3, G)
			print "Set Channel 1 to " + str(R)
			print "Set Channel 2 to " + str(G)
			print "Set Channel 3 to " + str(B)
...
myDMX = PyDMX(2,6, 2, 5, [255,0,0,255,0,0], "/dev/tty.usbserial-EN169205", True)
